...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Title
\def\thesistitle{Etude de dynamiques de photoionisation résonante à l'aide d'impulsions attosecondes}
...
% PhD
\newcommand{\PhDTitleFR}{\'{E}tude de dynamiques de photoionisation résonante à l'aide d'impulsions attosecondes} %% Titre en Français
\newcommand{\PhDkeywordsFR}{Des mots clés} %% 3 à 6 mots clefs
\newcommand{\PhDsumFR}{Blablabla} %% Résumé en Français

\newcommand{\PhDTitleEN}{Application of attosecond pulses to resonant photoionization dynamics} %% Title in English
...
\newcommand{\defensedate}{18 Décembre 2017} % Date of defense
