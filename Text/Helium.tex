...
La spectroscopie d'absorption mesure la section efficace d'absorption $\sigma (\omega)$. D'après la loi de Beer-Lambert, l'intensité du champ $F(t,z) = F_0 \: \rme^{i \omega t - k z}$ après propagation sur une distance $l$ dans un milieu de densité $\rho$ est donnée par
\begin{equation}
