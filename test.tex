...
\newcommand{\logoED}{\includegraphics[scale=1.2]{Figures/Logos/EDOM.jpg}} % Logo of doctoral school. Check the name of the correct file in the /logo folder.
\newcommand{\logoEt}{\includegraphics[scale=1.2]{Figures/Logos/UPS.png}} % Must be the logo corresponding to %PhD working place. Check the name of the correct file in the /logo folder.
...
\begin{document}
%% La page de garde :
\input{Misc/style-pagedegarde} %% Have to be compiled twice in before getting the square correctly positionned.
