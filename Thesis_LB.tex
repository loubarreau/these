%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%																												 %%
%%		q			Master .tex File - Compile this								 %%
%%																												 %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\setSingleSpace{1.10} \SingleSpace %very slightly increases the line spacing (by 5%). 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CHAPTERS
\input{Text/GHOE.tex}
%\input{Text/DelaisPI.tex}
%\input{Text/Helium.tex}
%\input{Text/Argon.tex}
%\input{Text/Polarimetrie.tex}
...
\bibliography{Bib/Lou_Bibliography}
\cleardoublepage
